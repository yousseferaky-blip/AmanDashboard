...
>
  ...
  <motion.div 
    ...
    className="relative bg-gradient-to-br from-[#022949] via-[#022949] to-[#0a3a5c] rounded-2xl p-8 text-white shadow-2xl overflow-hidden"
  >
    ...
    <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
      <div className="flex-1">
        ...
        >
          <div className="w-2 h-2 bg-[#D89022] rounded-full animate-pulse"></div>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="group flex items-center gap-3 px-6 py-3 bg-[#D89022]/30 hover:bg-[#D89022]/50 backdrop-blur-sm border border-[#D89022]/40 text-white rounded-xl transition-all duration-300 disabled:opacity-50 shadow-lg"
      >
  ...
  {loading && (
    ...
    >
      <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#022949] mb-4"></div>
          ...
          <div className="relative z-10">
            ...
            <div className="w-full bg-gray-100 rounded-full h-1.5 overflow-hidden">
              <motion.div 
                ...
                className="h-full rounded-full bg-gradient-to-r from-[#D89022] to-[#F58818]"
              ></motion.div>
            </div>
          </div>
        </motion.div>
  ...
  {!loading && !error && dashboardData && (
    ...
    >
      <div className="bg-gradient-to-r from-[#022949] to-[#0a3a5c] px-6 py-4 border-b border-[#0a3a5c]">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-[#D89022] rounded-xl flex items-center justify-center shadow-lg">
            <HiClipboardList className="w-5 h-5 text-white" />
          </div>
          <div>
            <h3 className="text-xl font-bold text-white">الطلبات الأخيرة</h3>
            <p className="text-sm text-white/70">آخر الطلبات المكتملة</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-6">
        {dashboardData.recentOrders && dashboardData.recentOrders.length > 0 ? (
          <div className="space-y-4">
            {dashboardData.recentOrders.map((order, index) => (
              <motion.div
                ...
                className="flex items-center justify-between p-4 rounded-lg bg-gray-50 hover:bg-[#022949]/5 transition-colors"
              >
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-[#022949]/10 rounded-full flex items-center justify-center">
                    <span className="text-[#022949] font-bold text-sm">#{order.rideId}</span>
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-lg font-bold text-[#022949]">
          ...
          <div className="text-center py-12">
            <div className="w-16 h-16 bg-[#022949]/10 rounded-full flex items-center justify-center mx-auto mb-4">
              <HiClipboardList className="w-8 h-8 text-[#022949]" />
            </div>
